    ...
    return (
        <>
            <div className="flex flex-col text-lg text-center justify-center items-center font-serif space-y-5 mt-15">
                <Map />
                <div className={`border-2 border-[#383838] font-['IBMPlexSans'] text-lg rounded-lg p-5 mb-20 ${themeClasses.textHolder} ${themeClasses.skillText}`}>
                    Hello, I am a curious programmer and developer !
                </div>
                <div className={`${themeClasses.text} font-['IBMPlexSans'] text-justify max-w-[50ch] break-words`}>
